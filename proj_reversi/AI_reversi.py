...
class Model:
	...
	def __init__(self):
		...
		# Define Q networks
		self.weights = {
			'wc1': tf.get_variable('wc1', [3, 3, 4, 32], initializer = tf.contrib.layers.xavier_initializer()),
		...
		self.weights_T = {
			'wc1': tf.get_variable('wc1T', [3, 3, 4, 32], initializer = tf.contrib.layers.xavier_initializer()),
	...
	def forward(self, x, weights, biases):
		...
		x = dense(x, weights['wd2'], biases['bd2'], activation = 'x', use_bn = False)
