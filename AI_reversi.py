...
class Model:
	...
	def __init__(self):
		...
		# Define Q networks
		self.weights = {
			'wc1': tf.get_variable('wc1', [3, 3, 3, 32], initializer = tf.contrib.layers.xavier_initializer()),
			...
			'wc4': tf.get_variable('wc4', [3, 3, 32, 32], initializer = tf.contrib.layers.xavier_initializer()),
			'wd1': tf.get_variable('wd1', [8*8*32, 128], initializer = tf.contrib.layers.xavier_initializer()),
			'wd2': tf.get_variable('wd2', [128, 64], initializer = tf.contrib.layers.xavier_initializer())
		}
		self.biases = {
			'bc1': tf.get_variable('bc1', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bc2': tf.get_variable('bc2', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bc3': tf.get_variable('bc3', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bc4': tf.get_variable('bc4', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bd1': tf.get_variable('bd1', [128], initializer = tf.contrib.layers.xavier_initializer()),
		...
		self.weights_T = {
			'wc1': tf.get_variable('wc1T', [3, 3, 3, 32], initializer = tf.contrib.layers.xavier_initializer()),
			'wc2': tf.get_variable('wc2T', [3, 3, 32, 32], initializer = tf.contrib.layers.xavier_initializer()),
			'wc3': tf.get_variable('wc3T', [3, 3, 32, 32], initializer = tf.contrib.layers.xavier_initializer()),
			'wc4': tf.get_variable('wc4T', [3, 3, 32, 32], initializer = tf.contrib.layers.xavier_initializer()),
			'wd1': tf.get_variable('wd1T', [8*8*32, 128], initializer = tf.contrib.layers.xavier_initializer()),
			'wd2': tf.get_variable('wd2T', [128, 64], initializer = tf.contrib.layers.xavier_initializer())
		}
		self.biases_T = {
			'bc1': tf.get_variable('bc1T', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bc2': tf.get_variable('bc2T', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bc3': tf.get_variable('bc3T', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bc4': tf.get_variable('bc4T', [32], initializer = tf.contrib.layers.xavier_initializer()),
			'bd1': tf.get_variable('bd1T', [128], initializer = tf.contrib.layers.xavier_initializer()),
	...
	def forward(self, x, weights, biases):
		...
		x = dense(x, weights['wd1'], biases['bd1'], activation = 'sigmoid')
